...
function DestroySemester({ id, onFlag }) {
    ...
    const handleClickDestroy = async (e) => {
        e.preventDefault();
        const toastId = toast.loading('Xóa học kỳ!');
        try {
            await axiosPrivate.delete(`/semester/${id}`);
        ...
        <>
            ...
            <div className="popup-root">
                <Modal props={props} onToggle={handleToggleModal}>
                    <p>Bạn chắc chắn xóa học kỳ này?</p>
...
export default memo(DestroySemester);
